<template>
  <div class="container">
    <div class="title"><span>添加宫格</span> <span class="back" @click="back(false)"> <i class="iconfont icon-fanhui"></i> 返回 </span></div>
    <div class="wrap">
      <el-row>
      ...
      this.$refs[formName].validate(async valid => {
        if (valid) {
          try {
            ...
            this.loading = true
            const res = await gridCategory.addGrid(this.form)
            this.loading = false
            if (res.error_code === 0) {
